...
public class tutor_getPending extends AsyncTask<String, String, String> {
    Activity parent;
    String result = "";
    String TutorID;
    List<Pending> in;
    ...
    public tutor_getPending(Activity par, String student_id , List<Pending> obj){
        parent = par;
        TutorID = student_id;
        in = obj ;
    }
    ...
    public tutor_getPending(Activity par){
        parent = par;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://neural.net16.net/tutor_pending.php");
        ...
        if (result.equals("null")) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArr.length(); i++) {
                    ...
                    in.add(new Pending(tutor_student_id,student_id,subjectName,subjectCode,date,time,studentName,studentSurname,description,R.drawable.yello,parent));
                }
