 ...
 */
public class tutor_getallsubjects extends AsyncTask<String, String, String> {
    Activity parent;
    String result = "";
    String tutorID;
    List<Subjects> in;
    ...
    public tutor_getallsubjects(Activity par, String tutor_id, List<Subjects> obj){
        parent = par;
        tutorID = tutor_id;
        in = obj;
    }

    public tutor_getallsubjects(Activity par){
        parent = par;
    }
    @Override
