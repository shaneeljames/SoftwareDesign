...
public class tutor_checkExpired extends AsyncTask<String, String, String> {
        Context parent;
...
public tutor_checkExpired(Context par, String tutor_student_id){
        parent = par;
...
protected String doInBackground(String... params) {
        ...
        try {
        url = new URL("http://neural.net16.net/tutor_checkexpired.php");
