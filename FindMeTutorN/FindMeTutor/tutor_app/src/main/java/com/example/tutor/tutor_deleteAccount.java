...
public class tutor_deleteAccount extends AsyncTask<String, String, String> {
    ...
    public tutor_deleteAccount(Activity par, String tid  ){
        this.parent = par;
        TutorID = tid ;
    ...
    public tutor_deleteAccount(Activity par){
        parent = par;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://neural.net16.net/tutor_archiveaccount.php");
