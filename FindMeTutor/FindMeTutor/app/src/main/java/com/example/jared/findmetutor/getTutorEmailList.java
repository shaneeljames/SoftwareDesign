 ...
 */
public class getTutorEmailList extends AsyncTask<String, String, String> {
    Activity parent;
    String result = "";
    String SubjectID;
    ...
    public getTutorEmailList(Activity par, String session_id, List<TutorsEList> obj){
        parent = par;
        SubjectID= session_id;
        in = obj;
    }

    public getTutorEmailList(Activity par){
        parent = par;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://neural.net16.net/student_gettutorselist.php");
              ...
              // Toast.makeText(parent.getApplicationContext(), "making object " + result, Toast.LENGTH_SHORT).show();
               ...
               for (int i = 0; i < jsonArr.length(); i++) {
                  ...
                  //Toast.makeText(parent.getApplicationContext(), code, Toast.LENGTH_SHORT).show();
                   in.add(new TutorsEList( tutID, tutNum, fullname,email, R.drawable.subj, parent));
               }
