...
\begin{tabular}{| p{8cm} | p{8cm} |} \hline
	...
	\textbf{Pass/Fail Criteria:}& The test passes if the user changes his/her profile picture with a valid image file\\
	\textbf{Input Data:}& File\\\hline
	\textbf{Test Procedure:}& \textbf{Expected Result:} \\\hline
	Step 1. Upload an invalid image file & The system does not change profile picture and indicates failure\\
	Step 2. Upload a valid image file & The system indicates success and changes the profile picture\\\hline
\end{tabular}
