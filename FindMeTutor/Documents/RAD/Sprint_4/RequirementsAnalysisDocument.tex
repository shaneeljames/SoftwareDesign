...
\begin{tabular}{| l | p{10cm}| }
    ...
    \begin{tabular}{| l | p{10cm}| }
      ...
      \multicolumn{2}{|l|}{3. System adds funds to tutor}\\
			\multicolumn{2}{|l|}{4. Invokes Rate Tutor}\\
			\multicolumn{2}{|l|}{5. Initiating actor and participating actor is checked out}\\
			 \hline
		\end{tabular}
