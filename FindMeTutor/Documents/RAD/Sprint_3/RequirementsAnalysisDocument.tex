...
\begin{tabular}{| l | p{10cm}| }
    ...
    \end{tabular}
		...
		\begin{tabular}{| l | p{10cm}| }
			...
			Related Requirements: &  RQ8.1, RQ9.1\\ \hline
			Initiating actor: & Student, Tutor \\ \hline
			Actor goal: & To cancel a session\\ \hline
			Participating Actors: &\\ \hline
			Preconditions: &Initiating actor exists\\ \hline
		...
		\begin{tabular}{| l | p{10cm}| }
			\hline\multicolumn{2}{|c|}{ \textbf{Use Case UC-AF: Update Funds } }\\ \hline
			Related Requirements: & RQ8.3, RQ9.3 \\ \hline
			Initiating actor: & Student, Tutor \\ \hline
			Actor goal: & To cancel a session\\ \hline
			Participating Actors: \\ \hline
			Preconditions: &Initiating actor exists\\ \hline
		...
		\begin{tabular}{| l | p{10cm}| }
			...
			Related Requirements: &  RQ8.2, RQ9.2\\ \hline
			Initiating actor: & Student, Tutor \\ \hline
			Actor goal: & To cancel a session\\ \hline
			Participating Actors: \\ \hline
			Preconditions: &Initiating actor exists\\ \hline
...
\end{flushleft}
\begin{flushleft}
3.5.6 Azure -Web server to host the database (as Amazon web services could no longer host our application)
\end{flushleft}
