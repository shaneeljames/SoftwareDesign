...
public class tutor_checkout extends AsyncTask<String, String, String> {
    Activity parent;
    String result = "";
    String TutorStudentID;
    String Checkin ;

    public tutor_checkout(Activity par, String tsi , String c){
        parent = par;
        TutorStudentID = tsi;
        Checkin = c;
    }

    public tutor_checkout(Activity par){
        parent = par;
    }
    @Override
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://neural.net16.net/tutor_checkout.php");
        ...
        parameter.put("tutor_checkin", Checkin);
