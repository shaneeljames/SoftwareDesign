...
public class tutor_cancel extends AsyncTask<String, String, String> {
    ...
    public tutor_cancel(Context par, String tutor_student_id){
        parent = par;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            url = new URL("http://neural.net16.net/tutor_cancel.php");
