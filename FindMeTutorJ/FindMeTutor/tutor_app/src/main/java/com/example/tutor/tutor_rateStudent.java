...
public class tutor_rateStudent extends AsyncTask<String, String, String> {
        Context parent;
        String result = "";
        String StudentID;
...
public tutor_rateStudent (Context par, String studentID, String tsi , String r){
        parent = par;
        StudentID = studentID;
        TutorStudentID = tsi ;
        Rating = r ;
...
public tutor_rateStudent(Context par){
        parent = par;
        }
@Override
protected String doInBackground(String... params) {
        ...
        try {
        url = new URL("http://neural.net16.net/tutor_ratestudent.php");
